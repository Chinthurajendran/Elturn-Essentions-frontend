...
export default function EditAdminUser() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const existingUser = {
        ...
        password: "", // Password field typically empty for security
        role: "Admin",
        status: true,
      }
  ...
  if (loading) {
    return (
      <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-12 flex items-center justify-center">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden p-6 sm:p-8 lg:p-10">
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            All fields except password are required. Leave password blank to
