...
export default function AddCouponPage() {
  ...
  const subCategoryOptions = {
    All: [],
    Men: ["Shirts", "T-Shirts", "Jeans", "Trousers", "Jackets", "Shoes", "Accessories"],
    Women: ["Tops", "Dresses", "Jeans", "Trousers", "Jackets", "Shoes", "Accessories", "Handbags"],
    Unisex: ["T-Shirts", "Hoodies", "Caps", "Sunglasses", "Watches", "Backpacks"],
  }
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      // API call: await api.createCoupon(form)
      setLoading(false)
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-red-800/70">
            Set up discount coupons for your customers
          </p>
        </div>
        ...
        <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 uppercase border-2 border-red-200 rounded-xl px-4 py-3 focus:outline-none focus:border-red-400 transition-colors"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg shadow-red-100 border border-red-100 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {form.category !== "All" && subCategoryOptions[form.category]?.length > 0 && (
                <div>
                  <label className="block text-sm font-semibold text-red-900 mb-2">
