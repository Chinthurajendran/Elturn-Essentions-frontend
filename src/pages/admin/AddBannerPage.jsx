...
export default function AddBannerPage() {
  ...
  return (
    <div className="min-h-screen ">
      {/* Page Title */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-red-600">Add Banner</h1>
      ...
      >
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              onClick={() => setForm({ ...form, type: "Image", file: null })}
            ...
            <button
              type="button"
              onClick={() => setForm({ ...form, type: "Video", file: null })}
              className={`flex items-center justify-center gap-3 p-4 rounded-2xl border-2 transition
                ${
                  form.type === "Video"
